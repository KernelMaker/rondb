...
ErrorBundle ErrorCodes[] = {
  ...
  { 4358, DMEC, AE, "deleteOldest is not supported on a ring buffer table with TTL" },
  { 4359, DMEC, AE, "Inserts on a ring buffer table with TTL must set every column" },
  { 4360, DMEC, AE, "TTL ignore and TTL only-expired options cannot be combined" },
